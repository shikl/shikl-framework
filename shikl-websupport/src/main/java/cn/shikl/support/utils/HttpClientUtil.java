...
public class HttpClientUtil {
    ...
    private static Map<String, Object> defaultHeader = new HashMap();
    ...
    public static String httpGetRequest(String url, Map<String, Object> params)
        ...
        return httpGetRequest(url,defaultHeader, params );
    }
    ...
    public static String httpPostRequest(String url, String json){
        ...
        return httpPostRequest(url, defaultHeader, json);
    }
    ...
    private static String getResult(HttpRequestBase request) {
        ...
        try {
            ...
            if (entity != null) {
                ...
                response.close();
                logger.debug("httpclient return => {}", result);
                return result;
            }
    ...
    public static void main(String args[]) throws UnsupportedEncodingException {
        HttpClientUtil.httpPostRequest("http://192.168.9.11:8080/education/person/export","{eduId:'123123123'}");
    }
